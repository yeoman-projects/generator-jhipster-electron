# Contributing to Electron for JHipster

Are you ready to contribute to Electron for JHipster? We'd love to have you on board, and we will help you as much as we can. Here are the guidelines we'd like you to follow so that we can be of more help:
...
This is the Electron for JHipster bug tracker, and it is used for [Issues and Bugs](#issue) and for [Feature Requests](#feature). 

If you have a question on using Electron for JHipster, or if you need help with your JHipster project, please [read JHipster's help page](http://www.jhipster.tech/help/) and use the [JHipster](http://stackoverflow.com/tags/jhipster) and [Electron](https://stackoverflow.com/tags/electron) tags on StackOverflow or join our [Gitter.im chat room](https://gitter.im/jhipster/generator-jhipster).

## <a name="issue"></a> Issues and Bugs
If you find a bug in the source code or a mistake in the documentation, you can help us by [submitting a ticket](https://opensource.guide/how-to-contribute/#opening-an-issue) to our [GitHub issues](https://github.com/amanganiello90/generator-jhipster-electron/issues). Even better, you can submit a pull request to the [Electron for JHipster generator project](https://github.com/amanganiello90/generator-jhipster-electron).

**Please see the Submission Guidelines below**.

## <a name="feature"></a> Feature Requests
You can request a new feature by submitting a ticket to our [GitHub issues](https://github.com/amanganiello90/generator-jhipster-electron/issues). If you
...
Before you submit your issue search the [archive](https://github.com/amanganiello90/generator-jhipster-electron/issues?utf8=%E2%9C%93&q=is%3Aissue), maybe your question was already answered.
...
Click [here](https://github.com/amanganiello90/generator-jhipster-electron/issues/new) to open a bug issue with a pre-filled template. For feature requests and enquiries you can use [this template][feature-template].
...
* Search [GitHub](https://github.com/amanganiello90/generator-jhipster-electron/pulls?utf8=%E2%9C%93&q=is%3Apr) for an open or closed Pull Request
...
* Generate a new Electron for JHipster project, and ensure that all tests pass

     ```shell
     yo jhipster-electron <name>
     cd name &&  npm run package
     ```

* Test that the new project runs correctly clicking on your **exe file**.
...
* In GitHub, send a pull request to `amanganiello90/generator-jhipster-electron:master`.
...
Electron for JHipster is a [JHipster Module](http://www.jhipster.tech/modules/creating-a-module/). You might want to follow the [Yeoman authoring documentation](http://yeoman.io/authoring/) in order to be able to run and test your changes.

Here are the most important steps.

### Fork the generator-jhipster-electron project

Go to the [generator-jhipster-electron project](https://github.com/amanganiello90/generator-jhipster-electron) and click on the "fork" button. You can then clone your own fork of the project, and start working on it.

[Please read the GitHub forking documentation for more information](https://help.github.com/articles/fork-a-repo)

### Set NPM/YARN to use the cloned project

In your cloned `generator-jhipster-electron` project, type `npm link` or `yarn link` depending on the package manager you use.
...
1. run `npm link` or `yarn link` on the `generator-jhipster-electron` project
2. run `npm link generator-jhipster-electron` or `yarn link generator-jhipster-electron` on the generated application folder (you need to do this for each application you create)

Now, running the `yo jhipster-electron` command should use your specific Electron for JHipster version. You can test it by making a small change in your cloned generator, and running again on an existing Electron project:
